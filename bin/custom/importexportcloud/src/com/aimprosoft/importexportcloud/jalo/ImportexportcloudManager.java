 ...
 */
package com.aimprosoft.importexportcloud.jalo;

import com.aimprosoft.importexportcloud.constants.ImportexportcloudConstants;
...
/**
 * This is the extension manager of the Importexportcloud extension.
 */
public class ImportexportcloudManager extends GeneratedImportexportcloudManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(ImportexportcloudManager.class);
	 ...
	 */
	public static ImportexportcloudManager getInstance()
	{
		return (ImportexportcloudManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ImportexportcloudConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ImportexportcloudManager() // NOPMD 
	{
		LOG.debug("constructor of ImportexportcloudManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of ImportexportcloudManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of ImportexportcloudManager called, current tenant: {}", getTenant().getTenantID());
	}
