 ...
 */
package com.aimprosoft.importexportbackoffice.jalo;
...
import com.aimprosoft.importexportbackoffice.constants.ImportexportbackofficeConstants;
 ...
 */
public class ImportexportbackofficeManager extends GeneratedImportexportbackofficeManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	private static final Logger LOG = Logger.getLogger(ImportexportbackofficeManager.class.getName());
	 ...
	 */
	public static ImportexportbackofficeManager getInstance()
	{
		return (ImportexportbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ImportexportbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ImportexportbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ImportexportbackofficeManager called.");
		}
	}
